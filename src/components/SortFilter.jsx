          ...
          <div className="flex items-center gap-3">
            ...
            <div className="sm:hidden">
              <select
                ...
                className="appearance-none rounded-lg border border-gray-300 bg-gray-100 px-4 py-2 pr-10 text-sm font-medium text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500/30 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:focus:ring-blue-400/30"
                style={{
